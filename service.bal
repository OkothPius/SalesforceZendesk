...
service / on new http:Listener(9090) {
    ...
    resource function get data() returns json|error {
        ...
        json getAccountByIdResponse = check salesforceEndpoint->getAccountById("0018d00000A2wcDAAR");
        string createAccountResponse = check salesforceEndpoint->createAccount({Name: "Jac Oruko", BillingCity: "Nairobi 047"});
        string createContactResponse = check salesforceEndpoint->createContact({description: "Created_from_Ballerina_Sf_Bulk_API", FirstName: "Derek", LastName: "Milla", Title: "Professor Grade 03", Phone: "0442226670", Email: "morne89@gmail.com"});
        ...
        support:Users listUsersResponse = check supportEndpoint->listUsers();
        return listUsersResponse.toJson();
    }
}
